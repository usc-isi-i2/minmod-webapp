					...
					<c:otherwise>
						<div class="toMultiLine <c:if test='${ela.getLang() != null && !ela.getLang().equals("")}'> lang ${ela.getLang()}" data-lang="${ela.getLang()}</c:if>">
							<div class="fixed">
								...
								${ela.getValue()}&#160;
                                                                <c:if test='${ela.getNsDataType().equals("ogc:wktLiteral")}'>
                                                                        <br><hr>
                                                                        <div class="map" id="map" style="height:400px;border-style:solid;border-width:1px;border-color:black;"></div>
                                                                        <script type="text/javascript">
                                                                          var myData = "${ela.getValue()}";
